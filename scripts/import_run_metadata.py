...
ARTIFACT_TYPE_STAGE_MAP = {
    ...
    "source_export_manifest": "bridge",
    "source_attestation": "bridge",
    "source_truthfulness_report": "policy_release",
    "release_governance_report": "policy_release",
...
def read_bundle(out_base: Path) -> dict:
    ...
    return {
        ...
        "source_export_manifest": optional_json(out_base / "a_psi_run" / "source_export_manifest.json"),
        "source_attestation": optional_json(out_base / "a_psi_run" / "source_attestation.json"),
        "source_truthfulness_report": optional_json(out_base / "a_psi_run" / "source_truthfulness_report.json"),
        "release_governance_report": optional_json(out_base / "a_psi_run" / "release_governance_report.json"),
...
def import_artifact_map(bundle: dict) -> dict[str, Path]:
    artifacts = {
        ...
        "source_export_manifest": bundle["out_base"] / "a_psi_run" / "source_export_manifest.json",
        "source_attestation": bundle["out_base"] / "a_psi_run" / "source_attestation.json",
        "source_truthfulness_report": bundle["out_base"] / "a_psi_run" / "source_truthfulness_report.json",
        "release_governance_report": bundle["out_base"] / "a_psi_run" / "release_governance_report.json",
