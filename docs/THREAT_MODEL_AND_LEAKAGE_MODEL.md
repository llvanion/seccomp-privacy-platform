...
| semi-honest PJC assumptions | `S8` now has a repo-side input-commitment gate for bridge-generated CSV tamper detection; signed two-party evidence, result binding, value proof/policy, and malicious-secure PSI-SUM remain open |
